...
"""    X_train, X1_test, y_train, y1_test = train_test_split(X,y)
    ...
    classifier_types = [('KNN', KNeighborsClassifier(algorithm='auto', leaf_size=30, metric='minkowski',
           metric_params=None, n_jobs=1, n_neighbors=3, p=2,
           weights='distance')), ('Decision Tree', DecisionTreeClassifier(class_weight=None, criterion='gini', max_depth=None,
            max_features=None, max_leaf_nodes=None,
            min_impurity_split=1e-07, min_samples_leaf=1,
            min_samples_split=2, min_weight_fraction_leaf=0.0,
            presort=False, random_state=0, splitter='best')), ('SVM', SVC(C=1.0, cache_size=200, class_weight=None, coef0=0.0,
  decision_function_shape=None, degree=3, gamma='auto', kernel='linear',
  max_iter=-1, probability=False, random_state=None, shrinking=True,
  tol=0.001, verbose=False)), ('Naive Bayes', MultinomialNB(alpha=1.0, class_prior=None, fit_prior=True))]
...
def cancerClassifier():
	...
	data = pd.read_csv("C:/Users/Jvalant/Downloads/mukul/CMPE239/MyAssignment/MAIN PROJECT/breast-cancer-wisconsin-data/data.csv",header=0)# here header 0 means the 0 th row is our coloumn 
	...
	if output == 0:
		return render_template('cancerPrediction.html',value ="no cancer")
	else:
		return render_template('cancerPrediction.html',value ="cancer")
